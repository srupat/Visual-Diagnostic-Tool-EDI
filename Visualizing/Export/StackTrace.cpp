...
void StackTrace::printStackTrace(HANDLE hProcess)
{
    ...
    bool sym = SymInitialize(hProcess, "C:\\Users\\sruja\\source\\repos\\Visual_Test\\Debug", TRUE);
                ...
                if (GetThreadContext(hThread, &context))
                {
                        ...
                        SymFunctionTableAccess64, SymGetModuleBase64, nullptr))
                    {
                        ...
                        if (frame->getContextFlag() == 1)
                        {
                            ...
                            strFunctionNames.emplace_back('@');
                            strFunctionNames.emplace_back(frame->GetParameterName());
                            strFunctionNames.emplace_back('&');
                            strFunctionNames.emplace_back(frame->GetVariableName());
                            strFunctionNames.emplace_back('$');
                            printf("\n");
